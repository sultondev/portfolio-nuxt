...
<template>
  <div
    class="blog-item__wrapper dark:bg-grayDark bg-whiteLight xl:max-w-[300px] lg:max-w-[290px] xs:max-w-[300px] max-w-full"
  >
    ...
    <div class="lg:p-5 p-4">
      ...
      <div
        class="xl:mb-8 lg:mb-6 mb-4 blog-brief__text text-sm dark:text-grayLight"
      >
        {{ brief_text }}
      </div>
      ...
      <DNuxtLink
        ...
        class=""
        :classes="[linkDefaulClasses, 'hover:underline']"
      >
        <template #after-icon>
